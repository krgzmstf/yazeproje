...
export default function FeaturedProjects({ projects: apiProjects }: FeaturedProjectsProps) {
  ...
  const items = apiProjects && apiProjects.length > 0
    ? apiProjects.map(p => ({
        slug: p.slug,
        image: p.cover_image_url || "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80",
        title: p.title,
    ...
    <section className="bg-cream py-24 select-none">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          <Link href="/projects" className="flex items-center space-x-2 text-xs font-bold text-navy-dark hover:text-gold-dark mt-6 md:mt-0 transition-colors uppercase tracking-wider group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((project, idx) => (
            <Link
              key={idx}
              href={project.slug === "#" ? "/projects" : `/projects/${project.slug}`}
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden bg-navy-dark">
                ...
                <div className="absolute top-4 left-4 z-20">
                  <span className={`text-[10px] font-bold uppercase px-3 py-1.5 rounded-full text-white shadow-md ${
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <div className="flex justify-between items-center text-xs text-navy-dark/70 border-t border-navy/5 pt-4 mt-2">
                  ...
                  <span className="font-semibold text-navy-dark">{project.area}</span>
                </div>
              </div>
            </Link>
          ))}
